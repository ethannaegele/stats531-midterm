...
plt.plot(df_test.index[4:], realized_vol_2019_smooth.iloc[4:], label='Realized Volatility (Smooth Proxy)')
plt.plot(df_test.index[4:], np.sqrt(garch_vol_forecast_2019).iloc[4:], label='1-Step Forecasted Volatility')
...
plt.plot(df2.index, realized_vol_smooth, label='Realized Volatility (Smoothed Estimate)')
plt.plot(df2.index, estimated_vol_skewt, label='Model Estimated Volatility')
