...
#####  Model Diagnosis
We check causality and invertibility in this section. Causality is when the AR process has all roots that lie outside the unit circle. Invertability is when the MA process has all roots that lie outside the unit circle. We diagnose our best solution, ARIMA (3,1,2) below. As all roots lie outside the unit circle, our solution is both causal and invertible. 
...
A GARCH model can model volatility of the DAX Stock. The GARCH(1, 1) is shown below.
$$
\begin{aligned}
